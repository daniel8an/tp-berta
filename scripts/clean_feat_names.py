...
parser.add_argument(
    ...
    help="Which training task is to conduct",
    required=True,
)
parser.add_argument(
    "--task",
    ...
    help="Which part of datasets to standardize",
    required=True,
)
parser.add_argument(
    "--overwrite", action="store_true", help="Overwrite existing clean feature name map"
)
